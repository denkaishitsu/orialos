...
module.exports = function(enabledMetricsObj) {
  ...
  agentObj.refreshConfigration = function(configString) {
    ...
    try {
      ...
      console.error("[Auto-Scaling Agent] The following error indicated the connection between auto-scaling agent and its backend is unstable. Safe to ignore the error if it happened occasionally.")
